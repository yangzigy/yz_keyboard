...
static u8 uart1_tx_buf[256];
static u8 uart1_rx_buf[256];
S_UART uart2=
{
	USART2,
};
static u8 uart2_tx_buf[256];
static u8 uart2_rx_buf[256];
S_UART uart3=
{
	USART3,
};
...
static u8 uart3_tx_buf[1000];
static u8 uart3_rx_buf[1000];
S_UART uart4=
{
	UART4,
};
static u8 uart4_tx_buf[256];
static u8 uart4_rx_buf[256];
S_UART uart5=
{
	UART5,
};
...
#else
static u8 uart3_tx_buf[256];
static u8 uart3_rx_buf[256];
#endif
